...
open class MetalView: MTKView {
    ...
    func makeTexture(with cgImage: CGImage, id: String? = nil) throws -> MLTexture {
...
//    var videoTextureCaches: [String: CVMetalTextureCache?] = [:]
//
//    func makeTexture(with pixelBuffer: CVPixelBuffer, id: String? = nil) throws -> MLTexture {
//        guard metalAvaliable else {
//            throw MLError.simulatorUnsupported
//        }
//
...
//        var videoTextureCache = videoTextureCaches[id ?? UUID().uuidString]
//        if videoTextureCache == nil {
//            var cache: CVMetalTextureCache? = nil
//            if let device = device {
//                CVMetalTextureCacheCreate(kCFAllocatorDefault, nil, device, nil, &cache)
//            }
//            videoTextureCaches[id ?? UUID().uuidString] = cache
//            videoTextureCache = cache
//        }
//
//        guard let cache = videoTextureCache! else {
//            throw MLError.simulatorUnsupported
//        }
//
